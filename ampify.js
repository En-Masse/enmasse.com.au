 ...
 */
const addAmpVersionLink = function addAmpVersionLink(html, filePath) {
...
const ampify = function ampify(html, filePath) {
  let $
  let round
  ...
  let css = sass.renderSync({file: 'css/amponly.scss', outputStyle: 'compressed'}).css.toString()
  ...
  if ($('head style[amp-boilerplate]').length === 0) {
    $('head').prepend('<style amp-boilerplate>body{-webkit-animation:-amp-start 8s steps(1,end) 0s 1 normal both-moz-animation:-amp-start 8s steps(1,end) 0s 1 normal both-ms-animation:-amp-start 8s steps(1,end) 0s 1 normal bothanimation:-amp-start 8s steps(1,end) 0s 1 normal both}@-webkit-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-moz-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-ms-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-o-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}</style><noscript><style amp-boilerplate>body{-webkit-animation:none-moz-animation:none-ms-animation:noneanimation:none}</style></noscript>')
  }
...
recursive(inputDir, ['amp'], (err, files) => {
